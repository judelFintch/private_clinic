        ...
        <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#ui-rdv" aria-expanded="false" aria-controls="ui-rdv">
                <i class="icon-ribbon menu-icon"></i>
                <span class="menu-title">Rendew-vous</span>
                <i class="menu-arrow"></i>
              </a>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <h4 class="card-title">Nouvelle hospitalisation</h4>
                        <div class="d-flex">
                    ...
                    <form class="forms-sample row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label >Patient</label>
                                <input type="text" class="form-control form-control-sm" placeholder="Nom du patient">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" placeholder="Post_Nom du patient">
                            </div>
                            <div class="form-group">
                                <label >Date hospitalisation</label>
                                <input type="text" class="form-control form-control-sm" placeholder="Post_Nom du patient">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-multiple w-100" multiple="multiple">
                                    <option value="AL">Diabete</option>
